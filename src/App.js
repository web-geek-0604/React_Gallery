...
function App() {
  ...
  return (
    <div className='container mx-auto'>
      ...
      {isLoading ? <img src={Loading_icon} alt="loading" className="mx-auto h-screen w-full"/> : <div className="justify-center grid m-auto grid-cols-2 md:grid-cols-3 sm:grid-cols-2 gap-4">
          {images.map(image =>(
